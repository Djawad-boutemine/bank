...
<footer class="bg-dark-blue text-white py-10 full-width grid-system">
	<div class="grid lg:grid-cols-4">
    <div class="lg:flex lg:flex-col lg:justify-between">
		  <div class="logo">
			<svg class="mx-auto" xmlns="http://www.w3.org/2000/svg" width="139" height="20"
				><defs
		...
		<div class="icons flex gap-4 max-lg:py-8 justify-center">
	...
	<div class="lg:flex lg:flex-col lg:justify-between text-center">
		<span>About Us</span>
		<span>Conact</span>
		<span>Blog</span>
	</div>
    ...
    <div class="button m-5">
      <MainButton></MainButton>
		...
		<span class="text-dark-grey">&copy;Easybank. All Rights Reserved</span>
	</div>
  </div>
</footer>
